...
(setq casey-todo-file "x:/code/todo.txt")
(setq casey-log-file "x:/code/log.txt")
...
(defun casey-big-fun-c-hook ()
  ...
  (defun dave-header-format ()
     ...
     (insert "   $Date: $\n")
     (insert "   $Revision: $\n")
     (insert "   $Creator: Davide Stasio $\n")
     (insert "   $Notice: (C) Copyright 2019 by Dave Stasio. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
  ...
  (cond ((file-exists-p buffer-file-name) t)
        ((string-match "[.]hin" buffer-file-name) (dave-source-format))
        ((string-match "[.]cin" buffer-file-name) (dave-source-format))
        ((string-match "[.]h" buffer-file-name) (dave-header-format))
        ((string-match "[.]cpp" buffer-file-name) (dave-source-format)))
...
(define-key global-map [home] 'scroll-other-window-down)
(define-key global-map [end] 'scroll-other-window)
...
(define-key global-map "\377" 'kill-whole-line)
(define-key global-map [M-delete] 'kill-line)
...
(set-face-attribute 'default t :font "Liberation Mono-9.5")
